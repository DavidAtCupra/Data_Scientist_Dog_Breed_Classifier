...
- Detecting whether an image contains a **dog**, **human**, or **neither**.
...
|--------------|-------------|
| `dog_app_mod.ipynb` | Main Jupyter notebook containing all code and analysis. |
...
2. Run Jupyter Notebook:
   ```bash
   jupyter notebook dog_app_mod.ipynb
   ```

3. Optionally, re-train the model:
   ```bash
